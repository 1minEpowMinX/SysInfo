...
## [3.1.0](https://github.com/1minEpowMinX/SysInfo/compare/v3.0.0...v3.1.0) (2026-08-26)
...
* Render each manifest from a shared base and a per-browser overlay ([`689921a`](https://github.com/1minEpowMinX/SysInfo/commit/689921ade640b138413b171b365e6f10582ca349))
...
* Bundle the monospace face with the popup ([`13c7422`](https://github.com/1minEpowMinX/SysInfo/commit/13c74227fa161e8f425e775b0c92b1516ca272ea))
* Rebuild the status tab to read top-down ([`23a02ed`](https://github.com/1minEpowMinX/SysInfo/commit/23a02ed573ef1ca0ed12a9ef6f90f2b4b4ad0b49))
* Put the agent state ahead of the version chips ([`6c21d7f`](https://github.com/1minEpowMinX/SysInfo/commit/6c21d7f7649eecf0e83c304d234433d099bc4370))
* Show the history times in the interface language ([`7801d8c`](https://github.com/1minEpowMinX/SysInfo/commit/7801d8c5363be51d858d22d68e3b93e64d5e7f75))
* Report the failures that leave a form without the block ([`4498aa4`](https://github.com/1minEpowMinX/SysInfo/commit/4498aa49e7b61676eeec248e159cc8d0a1796d5f))
* Draw every icon in both browsers from one PNG set ([`0de1db3`](https://github.com/1minEpowMinX/SysInfo/commit/0de1db30acd7e23bf82ec5728ee949d50d57b7df))
...
* Prevent history entries for tickets that were not created from the form ([`ee691ce`](https://github.com/1minEpowMinX/SysInfo/commit/ee691ce480f77827d0747b5b7370e2f841cc09b4))
* Prevent history entries for tickets that were not created from the form ([`4978a48`](https://github.com/1minEpowMinX/SysInfo/commit/4978a48581315b2c907001947b95d72d21d0f0eb))
* Spell out a missing IP or uptime in the ticket text ([`683e950`](https://github.com/1minEpowMinX/SysInfo/commit/683e950079806cb7e0807ba05223a237667395fc))
* Spell out every missing field of the ticket block ([`6cb66b6`](https://github.com/1minEpowMinX/SysInfo/commit/6cb66b63d034e1966e31154c28b5e25c574be792))
* Stop the popup settings seed from aliasing the defaults ([`0941e39`](https://github.com/1minEpowMinX/SysInfo/commit/0941e394521bc4a0a953f89ba18e158179696ce9))
* Give every data row the same font ([`381c0fa`](https://github.com/1minEpowMinX/SysInfo/commit/381c0fae48ee9412bec1b178bf5dc3e3e095e8c2))
* Stop asking for a weight the UI font does not have ([`cd7025f`](https://github.com/1minEpowMinX/SysInfo/commit/cd7025f53b856b66cce1d557891fec708151a96e))
* Declare which language the popup is showing ([`78f9fb3`](https://github.com/1minEpowMinX/SysInfo/commit/78f9fb3bb2505d12f8ca1f11c8727db6e058d9f4))
* Draw the chip's remove button in the interface font ([`a32be17`](https://github.com/1minEpowMinX/SysInfo/commit/a32be176431d3c37521aa1c115edb1e722811ce7))
* Enlarge the version chip labels ([`26c5a41`](https://github.com/1minEpowMinX/SysInfo/commit/26c5a417164ff84d03f67647aa8d217d12414913))
* Stop the short tabs from ending in dead space ([`56461f5`](https://github.com/1minEpowMinX/SysInfo/commit/56461f57d4817961f7bc743a19e310a7f52d1a71))
* Stop clipping the settings tab ([`fd4c342`](https://github.com/1minEpowMinX/SysInfo/commit/fd4c3423396ffe7519fa261c596ef9b44bd4a320))
* Record history only for tickets the form created ([`9f7db8b`](https://github.com/1minEpowMinX/SysInfo/commit/9f7db8b737e0bca689e2dbffe5f720e445f11f8f))
* Report a missed ticket heading and anchor its selector ([`fec54d6`](https://github.com/1minEpowMinX/SysInfo/commit/fec54d69f1c1bbfd54caea4dc7368f0ff27aebc5))
* Watch for submissions only on a whitelisted request form ([`26bfc9b`](https://github.com/1minEpowMinX/SysInfo/commit/26bfc9b1a0864e6fe75411f57b421fb3f2166b79))
* Let a whitelist the user emptied close the insertion ([`9b35fe2`](https://github.com/1minEpowMinX/SysInfo/commit/9b35fe2b5485684b3b1b1a231c03f889521968cc))
* Honour the field toggles in the inserted block ([`a3f3a09`](https://github.com/1minEpowMinX/SysInfo/commit/a3f3a09999242883e4382d80865106b701e5ecb7))
* Settle the caller when a rejection carries no message ([`bd16798`](https://github.com/1minEpowMinX/SysInfo/commit/bd167984ef9bf9d540b94c506805656dfbc8b758))
* Count the first attempt in the retry log ([`659c1ea`](https://github.com/1minEpowMinX/SysInfo/commit/659c1ea937638c75d4d654f925d19fe0c9f8619a))
* Ship every asset the popup loads and the configuration it was packaged from ([`a2a7159`](https://github.com/1minEpowMinX/SysInfo/commit/a2a71591be7deb23dc09f96e6d9171516df86bc4))
...
* Collect deployment prerequisites into the release notes ([`08c98fd`](https://github.com/1minEpowMinX/SysInfo/commit/08c98fd0f7fff3bd1f47305045d8c127c2a76464))
...
* Name the boot time field after what it carries ([`72fe747`](https://github.com/1minEpowMinX/SysInfo/commit/72fe7475e5afb46ffe3faf219eac3c4a38402173))
* Move the icon set into its own assets subfolder ([`14fa1af`](https://github.com/1minEpowMinX/SysInfo/commit/14fa1af192880f520be299eb5c5f13430ded1204))
* Name the interface font stack once ([`27ae44b`](https://github.com/1minEpowMinX/SysInfo/commit/27ae44b12593ad82fc6a6af4f9f0fce8e3f047a9))
* Record why the popup's sizes are absolute ([`76cad14`](https://github.com/1minEpowMinX/SysInfo/commit/76cad142e044749170a5d2e4fceeabcdaf25330d))
* Move the data tab's padding out of the markup ([`16cda35`](https://github.com/1minEpowMinX/SysInfo/commit/16cda3508d308c1150afa5e5a16f5e38b6c7e501))
* Drop the bundled monospace face ([`c268b38`](https://github.com/1minEpowMinX/SysInfo/commit/c268b383914dfbc8e828d97f486640c89332be4a))
* Autoformatting ([`1ad5493`](https://github.com/1minEpowMinX/SysInfo/commit/1ad54935dda419580a966ecf913e385b091682ca))
* Bring the docstrings to the project standard ([`616cf2d`](https://github.com/1minEpowMinX/SysInfo/commit/616cf2d482b03d85b4ae0535fd3b9ad2d3a18f3e))
* Bump the extension to 2.1.0 ([`4d8cecb`](https://github.com/1minEpowMinX/SysInfo/commit/4d8cecb3452b569ae9c2e9abf80290f431981072))
* Cover the extension against a faked browser ([`063d476`](https://github.com/1minEpowMinX/SysInfo/commit/063d476d2353ea86e49ac143ce28e31698330432))
* Move the reasons out of the docstrings ([`96bdf20`](https://github.com/1minEpowMinX/SysInfo/commit/96bdf20f3d4260eafdec8ad01cb9c7cefbf2d87e))
* Close the holes the mutation check found ([`9a3dbf4`](https://github.com/1minEpowMinX/SysInfo/commit/9a3dbf4aa2a403149d126467492ff0fa5fde9bcb))
* Reach the branches the poll and the backstop were hiding ([`3748df6`](https://github.com/1minEpowMinX/SysInfo/commit/3748df66ed2793182a4c2e7b69673b3d7a22047e))
* Write the block through innerText alone ([`90d5bc1`](https://github.com/1minEpowMinX/SysInfo/commit/90d5bc1b7ddc1716d0d929efb1bd82904e698a7d))
* Mount the request form the submit watcher looks for ([`dbaf055`](https://github.com/1minEpowMinX/SysInfo/commit/dbaf05518644c002d26c4553e77efd18e933b275))
* Read deployment values from a configuration file ([`ce80985`](https://github.com/1minEpowMinX/SysInfo/commit/ce80985eac3236f5ca36044be093796182d2700f))
* Generate the browser's copy of the configuration ([`4c9b706`](https://github.com/1minEpowMinX/SysInfo/commit/4c9b7065611116712c5c65b47fcdfcb1291b110c))
* Take the agent origin and the whitelist seeds from the build configuration ([`1a6ab4e`](https://github.com/1minEpowMinX/SysInfo/commit/1a6ab4ebe43cb1a792f23cf4b8bf896e1f36fcde))
* Substitute the agent host into the status line instead of translating it ([`b5554bd`](https://github.com/1minEpowMinX/SysInfo/commit/b5554bd22106cfbe82cccaaddbb810774ab78934))
* Render each manifest from a shared base and a per-browser overlay ([`689921a`](https://github.com/1minEpowMinX/SysInfo/commit/689921ade640b138413b171b365e6f10582ca349))
* Lay out the delivery tree for both browsers in one command ([`b76d8bd`](https://github.com/1minEpowMinX/SysInfo/commit/b76d8bdbbf5cd21821e2d0489e5751335bd52885))
* Format JSON configuration for better readability ([`3dffd14`](https://github.com/1minEpowMinX/SysInfo/commit/3dffd14597a581a7304c822de2f37e5cc18b5a91))
* Hold the delivery to what the manifest can reach ([`fb290ef`](https://github.com/1minEpowMinX/SysInfo/commit/fb290efc286e673c18b6095b3110f52d3fcf62a5))

## [3.0.0](https://github.com/1minEpowMinX/SysInfo/compare/v2.0.0...v3.0.0) (2026-05-13)
...
* Harden DOM, messaging, and input handling ([`4f7adde`](https://github.com/1minEpowMinX/SysInfo/commit/4f7added27e95b9c6252ccab3cdd98daaaced6cb))
...
* Fix svgIcon — use innerHTML+firstElementChild instead of DOMParser ([`1dec7f4`](https://github.com/1minEpowMinX/SysInfo/commit/1dec7f4cf109e2b8c0009c228e8fd53bee4af745))
...
* Convert to ES modules with shared/constants.js ([`13a99d6`](https://github.com/1minEpowMinX/SysInfo/commit/13a99d66db883f69a9da609fba41c5165c3f3e20))
* Add esbuild to bundle content scripts ([`1d0b213`](https://github.com/1minEpowMinX/SysInfo/commit/1d0b2136eefdd8ed8fc417b7e52b18cca0b37836))

## [2.0.0](https://github.com/1minEpowMinX/SysInfo/compare/v.1.4.0...v2.0.0) (2025-12-26)
...
## [1.4.0](https://github.com/1minEpowMinX/SysInfo/compare/v.1.3.2...v.1.4.0) (2025-02-13)
...
## [1.3.2](https://github.com/1minEpowMinX/SysInfo/compare/v.1.3.1...v.1.3.2) (2025-01-13)
...
## [1.3.1](https://github.com/1minEpowMinX/SysInfo/compare/v.1.3.0...v.1.3.1) (2025-01-09)
...
## [1.3.0](https://github.com/1minEpowMinX/SysInfo/compare/v.1.2.1...v.1.3.0) (2024-12-02)
...
## [1.2.1](https://github.com/1minEpowMinX/SysInfo/compare/v.1.2.0...v.1.2.1) (2024-11-28)
...
## [1.2.0](https://github.com/1minEpowMinX/SysInfo/compare/v.1.1.0...v.1.2.0) (2024-11-27)
...
## [1.1.0](https://github.com/1minEpowMinX/SysInfo/compare/v.1.0.0...v.1.1.0) (2024-11-27)
