 ...
 *        collects an answer.
 *
 * The interface App depends on for everything user-facing, which keeps widget
 * types out of the composition layer. MessageBoxPrompt in ui/ is the
 * widget-backed implementation the application runs with.
 *
